...
**Files:** `path/source-a:NN`, `path/source-b:MM`
...
- `explore` skill — use for the Phase 1 structural scan across many files.
- `brainstorming` skill — if an extraction candidate is large, load it before
  implementing.
