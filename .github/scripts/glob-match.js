// $KYAULabs: glob-match.js kyau@aura.kyaulabs 2026/08/11 -0700 Exp $

// Shared glob-to-regex matcher for the harness permission checkers
// (check-frontend-agent-contract.js and check-handoff-permissions.js).
// Implements OpenCode's documented permission-pattern matching
// (permissions.mdx): '*' matches zero or more of any character, '?'
