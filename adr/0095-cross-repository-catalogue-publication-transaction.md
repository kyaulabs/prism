...
Partially superseded by ADR-0096's Actions-only workflow-dispatch transport and separate dispatch-App authentication decision. Independent evidence validation, sequence safety, publication authority, protected-branch behavior, and human-only merge remain accepted.
