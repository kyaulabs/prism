...
If `code_only` is False (any changed file is a doc/paper/image): run the full Steps 3A–3C pipeline as normal. Video transcription (Step 2.5, transcribe reference) is out of scope for Phase 1 (#207).
