...
| The "expect()" function gives you access to a set of "expectations" as well as code
| introspection capabilities used in the "expect()->to*" methods.
|
*/
...
| your project that you don't want to repeat in every test file. Here you can also expose helpers as
 ...
 *
 * Handles the common gotcha: URLs like "https://example.com/config.json"
