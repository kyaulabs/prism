...
- `adr/0096-actions-only-catalogue-workflow-dispatch.md` — notify the publisher through a fixed workflow dispatch using a separate Actions-only App while preserving independent publication authority.
